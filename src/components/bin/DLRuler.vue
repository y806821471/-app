<template >
  <div>
    <div class="title_num">{{numberValue}}<span class="units" v-if="this.min == 100">cm</span><span class="units" v-else>kg</span></div>
    <div class="ruler " ref="testAA" >
      ...
      <div class="arrow">
        <img src="../../assets/img/zhizhen.png" alt="">
      </div>
    </div>
  </div>
</template>
